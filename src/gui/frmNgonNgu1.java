 ...
 * @author yushu
 */
public class frmNgonNgu1 extends javax.swing.JFrame {
     ...
     */
    public frmNgonNgu1() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNgonNgu1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmNgonNgu1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(frmNgonNgu1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
