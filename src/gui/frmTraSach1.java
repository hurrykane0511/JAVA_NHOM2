 ...
 * @author dthan
 */
public class frmTraSach1 extends javax.swing.JFrame {

    private BLL_TraSachh bll;
    HashMap<String, String> hm_nv = new HashMap<String, String>();
    private Boolean kq = false;

    public frmTraSach1() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtSoNgayQuaHan, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 240, 100, 28));
        ...
        jPanel1.add(btnLuu, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 410, -1, 32));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, 890, 250));
        ...
        jPanel1.add(btnThoat, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 410, -1, 32));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 300, -1, -1));
        ...
        jPanel1.add(txtDocGia, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 110, 170, 28));

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel9.setText("Tên đọc giả");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, -1, 28));
        ...
        jPanel1.add(txtMaTheThuVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 170, 100, 28));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel10.setText("Mã thẻ thư viện");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 170, -1, 23));
        ...
        jPanel1.add(btnMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 410, 100, 32));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTraSach1.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmTraSach1().setVisible(true);

                } catch (Exception ex) {
                    Logger.getLogger(frmTraSach1.class
