 ...
 * @author LENOVO
 */
public class frmNhapSach1 extends javax.swing.JFrame {
    ...
    public frmNhapSach1() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNhapSach1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmNhapSach1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(frmNhapSach1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
