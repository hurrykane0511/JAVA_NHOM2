 ...
 * @author yushu
 */
public class frmNhanVien1 extends javax.swing.JFrame {
    ...
    public frmNhanVien1() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmNhanVien1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmNhanVien1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(frmNhanVien1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
