 ...
 * @author LENOVO
 */
public class frmMuonSach1 extends javax.swing.JFrame {
     ...
     */
    public frmMuonSach1() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmMuonSach1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmMuonSach1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(frmMuonSach1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
