 ...
 * @author yushu
 */
public class frmTaiKhoan1 extends javax.swing.JFrame {

    /**
     * Creates new form frmTaiKhoan1
     */
    private BLL_TaiKhoan bll;
    private int STT;

    public frmTaiKhoan1() throws Exception {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTaiKhoan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new frmTaiKhoan1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(frmTaiKhoan1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
